          ...
          <table>
            ...
            <tbody>
              <tr>
                <th>관리비</th>
                <td colSpan="3">
                  <div class="styled__Wrap-sc-1nti3md-0 bTJwPT">
                    <input
                      name="maintenanceCost"
                      class="styled__Cost-sc-1nti3md-2 dZzEqg"
                      onInput={(e) => {
              ...
              <tr>
                ...
                <td>
                  <div class="styled__Wrap-sc-1nti3md-0 bTJwPT">
                    <label class="styled__OptionRadio-sc-1nti3md-9 iCkZFs">
                      <input
                        type="radio"
                        name="parking"
                        defaultChecked
              ...
              <tr>
                <th>
                  빌트인
                  <div class="styled__ShowUp-sc-1nti3md-10 ezRKI">
                    ...
                    <div class="styled__FlyBox-sc-1nti3md-11 iajGQB">
                      <h1>빌트인이란?</h1>
                      <p>
                ...
                <td>
                  <div class="styled__Wrap-sc-1nti3md-0 bTJwPT">
                    <label class="styled__OptionCheckbox-sc-1nti3md-7 styled__OptionLargeCheckbox-sc-1nti3md-8 eXAGyI kkuWgy">
              ...
              <tr>
                ...
                <td colSpan="3">
                  <div
                    class="styled__Wrap-sc-1nti3md-0 bTJwPT bTJwPTT"
                    style={{ flexWrap: "wrap" }}
                  >
